...
class Paralelepipedo : public MallaInd
{
  ...
  public:
    Paralelepipedo(){
      nombre_obj="paralelepipedo";
      num_ver=8;
      vector<Tupla3f> extremos = MinMax();
      Tupla3f minimo_extremo = extremos[0];
      Tupla3f maximo_extremo = extremos[1];
      Tupla3f a(maximo_extremo(0),maximo_extremo(1),minimo_extremo(2)), b(maximo_extremo(0),minimo_extremo(1),minimo_extremo(2)), c(maximo_extremo(0),minimo_extremo(1),maximo_extremo(2)), d(minimo_extremo(0),maximo_extremo(1),minimo_extremo(2)), e(minimo_extremo(0),minimo_extremo(1),maximo_extremo(2)),f(minimo_extremo(0),maximo_extremo(1),maximo_extremo(2));
      ver.reserve(num_ver);
      ver.push_back(maximo_extremo);
      ver.push_back(a);
      ver.push_back(b);
      ver.push_back(c);
      ver.push_back(d);
