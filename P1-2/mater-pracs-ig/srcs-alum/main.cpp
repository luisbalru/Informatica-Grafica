...
void FGE_PulsarTeclaNormal( unsigned char tecla, int x_raton, int y_raton )
{
   ...
   switch (toupper(tecla))
   {
      ...
      case 'V':
          if(contextoVis.VBOs){
            contextoVis.VBOs = false;
            cout<<"Se ha desactivado el modo diferido" << endl;
          }
          else{
            contextoVis.VBOs = true;
            cout<<"Se ha activado el modo diferido" << endl;
          }
          break;
      default:
         redibujar = false ;
